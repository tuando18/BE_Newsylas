...
template.innerHTML = `
    ...
    <div class="container-fluid post-container p-3 align-items-center mb-2">
        <div class="d-flex w-auto">
            ...
            <div class="wrapper d-flex flex-column">
                ...
                <span style="font-size: 0.7rem; color: #5b5e62" class="content-container">
                    <span style="font-weight: bold;" id="user-name">Admin</span> đã đăng <span id="time-up">25</span>
                </span>
...
class CardPost extends HTMLElement {
    static get observedAttributes() {
        return ['title', 'time', 'content', 'img']; // Thêm thuộc tính 'likes' và 'comments'
    }
